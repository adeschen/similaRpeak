...
test.similarity_non_numeric_diffPosMaxThresholdMaxDiff<- function() {
    obs <- tryCatch(ChIPprofileSimilarity:::similarity(profile1=c(1,59,6,24,65,34,15,4,53,22), profile2=c(15,9,46,44,9,39,27,34,34,4), diffPosMaxThresholdMaxDiff="g"), error=conditionMessage)
    exp <- "The 'diffPosMaxThresholdMaxDiff' must be a positive numeric value."
    checkIdentical(obs, exp, msg="similarity_non_numeric_diffPosMaxThresholdMaxDiff() - A non numeric diffPosMaxThresholdMaxDiff did not generate an exception with expected message.")
}

## Test the result of negative diffPosMaxThresholdMaxDiff
test.similarity_negative_diffPosMaxThresholdMaxDiff<- function() {
    obs <- tryCatch(ChIPprofileSimilarity:::similarity(profile1=c(1,59,6,24,65,34,15,4,53,22), profile2=c(15,9,46,44,9,39,27,34,34,4), diffPosMaxThresholdMaxDiff=-0.2), error=conditionMessage)
    exp <- "The 'diffPosMaxThresholdMaxDiff' must be a positive numeric value."
    checkIdentical(obs, exp, msg="similarity_negative_diffPosMaxThresholdMaxDiff() - A negative diffPosMaxThresholdMaxDiff did not generate an exception with expected message.")
}
...
test.similarity_non_numeric_diffPosMaxThresholdMaxDiff<- function() {
    ...
    exp <- "The 'diffPosMaxTolerance' must be a positive numeric value between 0 and 1 included."
    checkIdentical(obs, exp, msg="similarity_non_numeric_diffPosMaxThresholdMaxDiff() - A non numerical diffPosMaxThresholdMaxDiff did not generate an exception with expected message.")
}
...
test.similarity_zero_diffPosMaxThresholdMaxDiff<- function() {
    obs = tryCatch(ChIPprofileSimilarity:::similarity(profile1=c(1,59,6,24,65,34,15,4,53,22), profile2=c(15,9,46,44,9,39,27,34,34,4), diffPosMaxThresholdMaxDiff=0), error=conditionMessage)
    exp = "The 'diffPosMaxThresholdMaxDiff' must be a positive numeric value."
    checkEquals(obs, exp, msg="similarity_zero_diffPosMaxThresholdMaxDiff() - A zero value diffPosMaxThresholdMaxDiff dit not generate the expected exception.")
}

## Test the result of zero numeric ratioAreaThreshold
test.similarity_zero_ratioAreaThreshold<- function() {
    obs <- tryCatch(ChIPprofileSimilarity:::similarity(profile1=c(1,59,6,24,65,34,53,4,53,22), profile2=c(15,9,46,44,9,39,27,34,34,4), ratioAreaThreshold=0), error=conditionMessage)
    exp <- "The 'ratioAreaThreshold' must be a positive numeric value."
    checkEquals(obs, exp, msg="similarity_zero_ratioAreaThreshold() - A zero value ratioAreaThreshold dit not generate the expected exception.")
}
...
test.similarity_zero_diffPosMaxTolerance<- function() {
    obs <- ChIPprofileSimilarity:::similarity(c(1,59,6,24,65,34,15,4,53,22), c(15,99,46,44,5,39,27,34,34,4), diffPosMaxTolerance=0)$metrics$DIFF_POS_MAX
    exp <- 3
    checkEquals(obs, exp, tolerance = .Machine$double.eps^0.5, msg="similarity_zero_diffPosMaxTolerance() - A zero value diffPosMaxTolerance dit not generate the expected DIFF_POS_MAX value")
}
