...
## Demonstration ChIP-Seq profiles
...
Here is how to load the `demo_profiles` used in following sections. The 
ChIP-Seq profiles of the enhancers H3K27ac and H3K4me1 for the region are 
shown for the region chr19:27739373-27739767. The profiles are in reads 
per millions (RPM).

```{r demo_profiles_loading, collapse=T}
data("demo_profiles")
str(H3K27ac_chr19_profile, vec.len = 15)
str(H3K4me1_chr19_profile, vec.len = 15)
