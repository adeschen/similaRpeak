...
(Adersson et al. 2014, FANTOM5 consortium, Hnisz et al. 2013). Highly active 
...
plot(H3K27ac_chr7_profile*length(H3K27ac_chr7_profile)/sum(H3K27ac_chr7_profile,
        na.rm=TRUE), type="l", col="blue", xlab="", ylab="", ylim=c(0, 3.5))
par(new=TRUE)
plot(H3K4me1_chr7_profile*length(H3K4me1_chr7_profile)/sum(H3K4me1_chr7_profile,
        na.rm=TRUE), type="l", col="darkgreen", xlab="Position", 
