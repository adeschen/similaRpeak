...
specific region, two `vector` containing the RPM values of the two ChIP-Seq 
profiles for each position of the selected region. Both `vector` should have 
the same length and should not contain any negative value.
...
```{r ratio_area, echo=FALSE, fig.width=11, fig.height=8}
