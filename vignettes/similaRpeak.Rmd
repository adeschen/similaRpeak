...
difference is always the first profile value minue the second profile value. 
...
Super-enhancer regions found in the mouse embryonic stem cells thought to be 
...
overlap surrounding those super-enhancer regions at two histone 
post-transcriptional modifications linked to highly active enhancers H3K27ac 
(DCC accession: ENCFF000ASG) and H3K4me1 (DCC accession: ENCFF000ARY). 

A region, chr7:61968807-61969730, shows interesting profiles for both histones.
Let's calculate the metrics for this region.

```{r profiles}
profile1 <- c(3,59,6,24,65,112,144,77,53,22,21,12,11)
profile2 <- c(15,9,46,44,59,59,27,34,34,4,3,4,2)
```
