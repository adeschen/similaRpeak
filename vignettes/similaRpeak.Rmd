...
difference is always the first profile value less the second profile value. 
...
(`profile1` parameter) less the second profile value 
...
(`diffPosMaxThresholdMinValue` parameter) can be set to ensure that the maxumum
